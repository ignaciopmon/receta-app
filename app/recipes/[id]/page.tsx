    ...
    <div className="flex min-h-screen w-full flex-col bg-background">
      ...
      <main className="flex-1 w-full">
        ...
        <div className="w-full max-w-4xl mx-auto pt-8 pb-6 px-4 md:pt-12 md:px-6 text-center">
          ...
          {/* Título Principal */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-foreground mb-6 leading-tight tracking-tight text-balance animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
            {recipe.name}
          </h1>
