...
export default async function CookbooksPage() {
  ...
  // Nota: `cookbook_recipes(count)` es una característica de Supabase
  // que cuenta las filas relacionadas. Asumiremos que funciona.
  // Si no, necesitaríamos hacer un bucle y contar.
